...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        Toast toast = Toast.makeText ( this, "запись данных в контейнер ^_^", Toast.LENGTH_SHORT );
        toast.show ();
    }
    ...
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        Toast toast = Toast.makeText ( this, "считывание текста из контейнера ^_^", Toast.LENGTH_SHORT );
        toast.show ();
    }
